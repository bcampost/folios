...
return [
    ...
    'attributes'           => [
        ...
        'cost'                     => 'costo',
        'reason_for_rejection'     => 'razón de rechazo',
        'list_price'               => 'precio de lista',
        'state'                    => 'estado',
        'melamina_color'           => 'color de melamina',
        'tela_color'               => 'color de tela',
        'structure_color'          => 'color de estructura',
        'chapacinta_color'         => 'color de chapacinta'
    ],
];
