...
class PrecioDeListaAsignadoToFolioSolicitado extends Transition
{
    ...
    public function handle() : Folio
    {
        ...
        try {
            Mail::to([
                ...$this->folio->owner->managers()->get(),
                ...$this->folio->owner->leaders,
            ])->send(new FolioSolicitado($this->folio));
        } catch (\Exception $e) {
            //
        }
