...
class PrevioSolicitado extends Mailable
{
    ...
    )
    {
        ...
        if ($folio) {
            ...
            $this->folios = $project->folios()->where('state', PrevioSolicitadoState::getStateId())->get();
        }
    ...
    {
        return new Content(
            markdown: 'mails.previo.previo_solicitado',
        );
    }
